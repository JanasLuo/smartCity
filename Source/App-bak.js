(function () {
  ...
  var initialPosition = new Cesium.Cartesian3.fromDegrees(114.30385832,
    30.64797001, 2631.082799425431);
  ...
  var neighborhoodsPromise = Cesium.GeoJsonDataSource.load('./Source/SampleData/jiangan.geojson', geojsonOptions);
  ...
  var city = viewer.scene.primitives.add(new Cesium.Cesium3DTileset({ url: '/output/oldjianganwight2/tileset.json' }));
  ...
  var heightStyle = new Cesium.Cesium3DTileStyle({
    color: {
      conditions: [
        ...
        // ["${height6} >= 300", "rgba(45, 0, 75, 0.5)"],
        // ["${height6} >= 200", "rgb(102, 71, 151)"],
        // ["${height6} >= 100", "rgb(170, 162, 204)"],
        // ["${height6} >= 50", "rgb(86 104 216)"],
        // ["${height6} >= 25", "rgb(252, 230, 200)"],
        // ["${height6} >= 10", "rgb(248, 176, 87)"],
        // ["${height6} >= 5", "rgb(198, 106, 11)"],
        ["true", "rgb(127, 59, 8)"]
      ]
    }
  });
